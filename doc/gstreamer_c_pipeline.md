...
Then I added a task in [.vscode/task.json](../.vscode/task.json) and a launcher based on [this article](https://code.visualstudio.com/docs/cpp/config-linux). Nothing fancy. 
